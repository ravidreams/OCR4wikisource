...
logger.info("Running do_ocr.py " + latest_version)
...
if not pdf_count == text_count:
            ...
            logger.info(" \n\nText files are not equal to PDF files. Some PDF files not OCRed. Running this script again to complete OCR of all the PDF files \n\n")
